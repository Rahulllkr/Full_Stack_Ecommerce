...
const PlaceOrder = () => {
  ...
  // for razorpay payment initialise
  const initPay = (order) => {
    const options = {
      ...
      <div className='mt-8'>
        ...
        <div className='mt-12'>
          ...
          <div className='w-full text-end mt-8'>
            <button type='submit' className='bg-black cursor-pointer hover:bg-white hover:text-black border transition duration-300 text-white px-16 py-3 text-sm'>PLACE ORDER</button>
          </div>
        </div>
      </div>
